...
// kotlin-math 1.5.3 predates the tolerance-aware members added in 1.8.
// Preserve component-wise comparison for smooth animation convergence.
fun Float2.equals(other: Float2, delta: Float): Boolean =
    x.equals(other.x, delta) && y.equals(other.y, delta)

fun Float3.equals(other: Float3, delta: Float): Boolean =
    x.equals(other.x, delta) && y.equals(other.y, delta) && z.equals(other.z, delta)

fun Float4.equals(other: Float4, delta: Float): Boolean =
    x.equals(other.x, delta) && y.equals(other.y, delta) &&
        z.equals(other.z, delta) && w.equals(other.w, delta)

fun Mat4.equals(other: Mat4, delta: Float): Boolean =
    x.equals(other.x, delta) && y.equals(other.y, delta) &&
        z.equals(other.z, delta) && w.equals(other.w, delta)
