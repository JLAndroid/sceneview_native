 ...
 * [AndroidSceneViewHaptic] runs on every supported API down to `minSdk 21`,
...
/** Mirrors the injected SDK value; production reads Build.VERSION.SDK_INT. */
@androidx.annotation.ChecksSdkIntAtLeast(api = Build.VERSION_CODES.Q)
internal fun HapticEngine.supportsPredefinedEffects(): Boolean = sdkInt >= Build.VERSION_CODES.Q
