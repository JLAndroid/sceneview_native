...
class ModelAnimation(
    ...
    companion object {
         ...
         */
        @JvmField
        val TIME_POSITION: Property<ModelAnimation, Float> = object : Property<ModelAnimation, Float>(Float::class.javaObjectType, "timePosition") {
            override fun set(obj: ModelAnimation, value: Float) {
         ...
         */
        @JvmField
        val FRAME_POSITION: Property<ModelAnimation, Int> = object : Property<ModelAnimation, Int>(Int::class.javaObjectType, "framePosition") {
            override fun set(obj: ModelAnimation, value: Int) {
         ...
         */
        @JvmField
        val FRACTION_POSITION: Property<ModelAnimation, Float> = object : Property<ModelAnimation, Float>(Float::class.javaObjectType, "fractionPosition") {
            override fun set(obj: ModelAnimation, value: Float) {
